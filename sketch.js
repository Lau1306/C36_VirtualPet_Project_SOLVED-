...
function setup() {
  ...
  //1. crea aquí el boton Alimentar al perro
...
function draw() {
  ...
  //3. escribe el código para leer el valor de tiempo de alimentación de la base de datos
  ...
  //4. escribe el código para mostrar el texto lastFed time aquí
  fill(255,255,254);
  textSize(15);
  if(lastFed>=12){
...
function feedDog(){
  ...
  //2. escribe el código aquí para actualizar las existencia de alimento, y la última vez que se alimentó al perro
